    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            if (action.equals("validar")) {
                ...
                //variable local 
                Usuario us = uDao.validate(user, passw);

                if (us != null && us.getUsuario() != null) {
                    HttpSession sesion = request.getSession(true);
                    sesion.setAttribute("usuario", us);

                    jsonResponse.addProperty("succes", true);
                ...
                jsonResponse.addProperty("succes", resultado != 0);
            ...
            jsonResponse.addProperty("success", false);
            jsonResponse.addProperty("mesage", "Error" + e.getMessage());
